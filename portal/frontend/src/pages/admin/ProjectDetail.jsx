...
import { getProject, getProjectActivity, updateProject } from '../../api/projectApi.js';
import { listProjectMessages, sendProjectMessage } from '../../api/messageApi.js';
import { FILE_CATEGORY, ROLES } from '../../constants/index.js';
          ...
          project && (
            <>
              ...
              <ProjectActions
                ...
                user={user}
                onChanged={refetch}
                onDeleted={() => navigate('/admin/projects', { replace: true })}
              />
            </>
          )
        }
            ...
            <div className="grid grid-cols-1 gap-5 xl:grid-cols-3">
              <div className="space-y-5 xl:col-span-2">
                <Card>
                  ...
                  <CardBody>
                    {tab === 'overview' && (
                      <AssignmentManager project={project} assignments={assignments} onChanged={refetch} />
                    )}
              ...
              <div className="space-y-5">
                <Card>
                  ...
                  <CardBody>
                    <ProjectProgress project={project} onUpdated={refetch} />
                  </CardBody>
                </Card>

                <Card>
                  <CardHeader title="Status" description="Transitions are validated by the API." />
                  <CardBody>
                    <StatusChanger project={project} role={ROLES.ADMIN} onUpdated={refetch} />
                  </CardBody>
                </Card>
              </div>
            </div>
